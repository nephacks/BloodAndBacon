...
namespace Blood
{
  public class remotePlayer4 : GameScreen
  {
    ...
    public Rectangle rect_alivebodyRemote = new Rectangle(689, 549, (int) byte.MaxValue, 89);
    public Rectangle rect_alivebodyCheat = new Rectangle(689, 549, (int) byte.MaxValue, 89);
    ...
    public remotePlayer4(ContentManager content, Vector3 vv, ScreenManager scr)
    {
      ...
      this.bloodrem = (ParticleSystem) new dropSystemR(this.sc.Game, content);
    ...
    {
      this.now.byte_0 = (byte) 12;
      this.now.byte_1 = (byte) 12;
      this.now.leverOn = false;
      this.now.myscore = (ushort) 0;
      this.now.remscore = (ushort) 0;
      this.now.health = 190f;
      this.bloodExists = false;
      this.radius2 = 0.0f;
      this.gunfiredRadius2 = 0.0f;
      this.gunfiredDest2 = 0.0f;
    ...
    private void calcClips()
    {
      ...
      if ((double) this.dist > 0.0)
      {
        ...
        this.vec = new Vector3(this.v1.X, 0.0f, this.v1.Y) * 1.2f;
      }
