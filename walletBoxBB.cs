...
namespace Blood
{
  internal class walletBoxBB : GameScreen
  {
    ...
    private Rectangle rectangle_1 = new Rectangle(780, 0, 286, (int) byte.MaxValue);
    private Rectangle rectangle_2 = new Rectangle(282, 0, 286, (int) byte.MaxValue);
    private Rectangle rectangle_3 = new Rectangle(0, 269, 286, (int) byte.MaxValue);
    private Rectangle rectangle_4 = new Rectangle(286, 269, 286, (int) byte.MaxValue);
    private Rectangle rectangle_5 = new Rectangle(23, 658, 321, 337);
    private Rectangle rectangle_6 = new Rectangle(365, 658, 321, 337);
    ...
    private Rectangle rectangle_7 = new Rectangle(626, 139, 48, 48);
    private Rectangle rectangle_8 = new Rectangle(737, 137, 48, 48);
    private Rectangle rectangle_9 = new Rectangle(737, 64, 48, 48);
    private Rectangle rectangle_10 = new Rectangle(626, 66, 48, 48);
...
label_272:
    ...
    public override void Draw(GameTime gameTime)
    {
      ...
      if (this.choice == "controller" || this.choice == "controller2" || this.choice == "rebind" || this.choice == "hotkeys")
        this.scc = 1f;
      Matrix transformMatrix = Matrix.CreateScale(this.scc) * Matrix.CreateScale((float) this.sc.screenSize.Width / (float) this.sc.origSize.Width, (float) this.sc.screenSize.Height / (float) this.sc.origSize.Height, 1f);
      ...
      int x = (int) (443.0 * ((double) this.sc.screenSize.Width / (double) this.sc.origSize.Width));
      if ((double) this.sc.aspectratio > 1.0)
        x += (int) (((double) this.sc.screenSize.Width - (double) this.sc.screenSize.Width / (double) this.sc.aspectratio) * (0.5 * (double) this.sc.aspectratio));
      if (this.choice == "hotkeys" || this.choice == "rebind" || this.choice == "instructions" || this.choice == "controller" || this.choice == "video" || this.choice == "controller2")
        x = 0;
      this.sc.GraphicsDevice.ScissorRectangle = new Rectangle(x, this.sc.screenSize.Y, this.sc.screenSize.Width - x, this.sc.screenSize.Height);
      this.spriteBatch.Begin(SpriteSortMode.Deferred, BlendState.NonPremultiplied, (SamplerState) null, (DepthStencilState) null, walletBoxBB.clipit, (Effect) null, transformMatrix);
      if (this.choice == "restart")
      {
        int index = this.myIndex;
        this.myIndex = -1;
        Rectangle rectangle = this.rectangle_2;
        if (this.sc.tunnelDay.Contains(this.updownIndex) && this.sc.showTunnels)
        {
          int num2 = this.sc.tunnelDay.IndexOf(this.updownIndex);
          rectangle = this.rectangle_0;
          if (num2 == 1 && this.sc.tusk1 == 0)
            rectangle = this.rectangle_1;
          if (num2 == 2 && this.sc.tusk2 == 0)
            rectangle = this.rectangle_1;
          if (num2 == 4 && this.sc.tusk3 == 0)
            rectangle = this.rectangle_1;
        }
        Vector2 origin = new Vector2((float) rectangle.Width, (float) rectangle.Height) / 2f;
        this.spriteBatch.Draw(this.sc.paper1, this.paperPos, new Rectangle?(rectangle), Color.White, this.rot, origin, 1.2f, SpriteEffects.None, 0.0f);
        ...
        this.spriteBatch.DrawString(this.scribbleFont, walletBoxBB.b1, new Vector2(0.0f, 40f) + this.paperPos - this.scribbleFont.MeasureString(walletBoxBB.b1) / 2f + this.vec[1], new Color(120, 50, 0));
        walletBoxBB.b1.Length = 0;
        ...
        this.spriteBatch.DrawString(this.scribbleFont, walletBoxBB.b1, new Vector2(0.0f, 70f) + this.paperPos - this.scribbleFont.MeasureString(walletBoxBB.b1) / 2f + this.vec[1], color);
        if (!this.sc.usingMouse)
        {
          walletBoxBB.b1.Length = 0;
          walletBoxBB.b1.Append("yes");
          this.spriteBatch.DrawString(this.scribbleFont, walletBoxBB.b1, new Vector2(0.0f, 50f) + this.paperPos - this.scribbleFont.MeasureString(walletBoxBB.b1) / 2f + this.vec[2], this.bluePen);
          this.spriteBatch.Draw(this.sc.paper1, new Vector2(0.0f, 50f) + this.paperPos - origin + this.vec[3], new Rectangle?(this.rectangle_7), Color.White);
          walletBoxBB.b1.Length = 0;
          walletBoxBB.b1.Append("no");
          this.spriteBatch.DrawString(this.scribbleFont, walletBoxBB.b1, new Vector2(0.0f, 50f) + this.paperPos - this.scribbleFont.MeasureString(walletBoxBB.b1) / 2f + this.vec[4], this.bluePen);
          this.spriteBatch.Draw(this.sc.paper1, new Vector2(0.0f, 50f) + this.paperPos - origin + this.vec[5], new Rectangle?(this.rectangle_8), Color.White);
        }
        else
        {
      ...
      if (this.choice == "audio")
      {
        ...
        if (!this.sc.usingMouse)
          this.spriteBatch.Draw(this.sc.paper1, this.paperPos - origin + this.vec[10], new Rectangle?(this.rectangle_7), Color.White);
      ...
      if (this.choice == "video")
      {
        ...
        if (!this.sc.usingMouse)
        {
          this.spriteBatch.Draw(this.sc.paper1, this.paperPos - origin + this.vec[1], new Rectangle?(this.rectangle_10), Color.White);
        }
        else
        {
        ...
        if (!this.sc.usingMouse)
        {
          this.spriteBatch.Draw(this.sc.paper1, this.paperPos - origin + this.vec[3], new Rectangle?(this.rectangle_9), Color.White);
        }
        else
        {
        ...
        if (!this.sc.usingMouse)
        {
          this.spriteBatch.Draw(this.sc.paper1, this.paperPos - origin + this.vec[5], new Rectangle?(this.rectangle_7), Color.White);
        }
        else
        {
        ...
        float num3 = (float) (Math.Sin(gameTime.TotalGameTime.TotalMilliseconds / 40.0) / 2.0 + 0.60000002384185791);
        this.sc.color_enemy = this.updownIndex != 0 ? new Color(210, 0, 0, (int) byte.MaxValue) : new Color(210, 0, 0, (int) byte.MaxValue) * num3;
        this.sc.color_day = this.updownIndex != 2 ? new Color(210, 0, 0, (int) byte.MaxValue) : new Color(210, 0, 0, (int) byte.MaxValue) * num3;
        this.sc.color_clock = this.updownIndex != 1 ? new Color((int) byte.MaxValue, (int) byte.MaxValue, (int) byte.MaxValue, (int) byte.MaxValue) : new Color((int) byte.MaxValue, (int) byte.MaxValue, (int) byte.MaxValue, (int) byte.MaxValue) * num3;
        this.sc.color_player1 = this.updownIndex != 5 ? new Color((int) byte.MaxValue, (int) byte.MaxValue, (int) byte.MaxValue, (int) byte.MaxValue) : new Color((int) byte.MaxValue, (int) byte.MaxValue, (int) byte.MaxValue, (int) byte.MaxValue) * num3;
        this.sc.color_player2 = this.updownIndex != 6 ? new Color((int) byte.MaxValue, (int) byte.MaxValue, (int) byte.MaxValue, (int) byte.MaxValue) : new Color((int) byte.MaxValue, (int) byte.MaxValue, (int) byte.MaxValue, (int) byte.MaxValue) * num3;
        this.sc.color_weapons = this.updownIndex != 3 ? new Color((int) byte.MaxValue, (int) byte.MaxValue, (int) byte.MaxValue, (int) byte.MaxValue) : new Color((int) byte.MaxValue, (int) byte.MaxValue, (int) byte.MaxValue, (int) byte.MaxValue) * num3;
        this.sc.color_dpad = this.updownIndex != 4 ? new Color((int) byte.MaxValue, (int) byte.MaxValue, (int) byte.MaxValue, (int) byte.MaxValue) : new Color((int) byte.MaxValue, (int) byte.MaxValue, (int) byte.MaxValue, (int) byte.MaxValue) * num3;
        if (index != this.myIndex && this.myIndex != -1)
          this.sc.tick.Play(this.sc.ev, 0.1f, 0.0f);
      }
      if (this.choice == "game")
      {
        ...
        walletBoxBB.b1.Length = 0;
        walletBoxBB.b1.Concat(this.slider2);
        this.queryButtonX(new Rectangle(0, 0, (int) this.scribbleFont.MeasureString(walletBoxBB.b1).X, (int) this.scribbleFont.MeasureString(walletBoxBB.b1).Y), this.paperPos - this.scribbleFont.MeasureString(walletBoxBB.b1) / 2f + this.vec[4] + vector2, 1);
        Color color4 = this.bluePen;
        if (this.myIndex == 1)
          color4 = this.grnPen;
        this.spriteBatch.DrawString(this.scribbleFont, walletBoxBB.b1, this.paperPos - this.scribbleFont.MeasureString(walletBoxBB.b1) / 2f + this.vec[4] + vector2, color4);
        vector2 = new Vector2(-10f, -45f);
        string text18 = "gun-recoil";
        ...
        this.queryButtonX(new Rectangle(0, 0, (int) this.scribbleFont.MeasureString(walletBoxBB.b1).X, (int) this.scribbleFont.MeasureString(walletBoxBB.b1).Y), this.paperPos - this.scribbleFont.MeasureString(walletBoxBB.b1) / 2f + this.vec[9] + vector2, 4);
        Color color5 = this.bluePen;
        if (this.myIndex == 4)
          color5 = this.grnPen;
        this.spriteBatch.DrawString(this.scribbleFont, walletBoxBB.b1, this.paperPos - this.scribbleFont.MeasureString(walletBoxBB.b1) / 2f + this.vec[9] + vector2, color5);
        ...
        if (!this.sc.usingMouse)
          this.spriteBatch.Draw(this.sc.paper1, this.paperPos - origin + this.vec[11] + vector2, new Rectangle?(this.rectangle_7), Color.White);
      ...
      if (this.choice == "networking")
      {
        ...
        this.spriteBatch.Draw(this.sc.paper1, this.paperPos - origin + this.vec[11], new Rectangle?(this.rectangle_7), Color.White);
      }
      if (this.choice == "debugging")
      {
        Vector2 origin = new Vector2((float) this.myRect.Width, (float) this.myRect.Height) / 2f;
        ...
        this.spriteBatch.Draw(this.sc.paper1, this.paperPos - origin + this.vec[17], new Rectangle?(this.rectangle_7), Color.White);
      }
      if (this.choice == "cheat mode")
      {
        this.spriteBatch.Begin(SpriteSortMode.Deferred, BlendState.NonPremultiplied, (SamplerState) null, (DepthStencilState) null, walletBoxBB.clipit);
        ...
        this.spriteBatch.Draw(this.sc.paper1, this.paperPos - vector2 + this.vec[21], new Rectangle?(this.rectangle_7), Color.White);
      }
      if (this.choice == "level edit")
      {
        ...
        if (this.updownIndex <= 10)
        {
          ...
          this.spriteBatch.Draw(this.sc.paper1, this.paperPos - origin + this.vec[34], new Rectangle?(this.rectangle_7), Color.White);
        }
        else
        {
          if (this.updownIndex == 11)
          ...
          this.spriteBatch.Draw(this.sc.paper1, this.paperPos - origin + this.vec[72], new Rectangle?(this.rectangle_8), Color.White);
          string text99 = "Save";
          ...
          this.spriteBatch.Draw(this.sc.paper1, this.paperPos - origin + this.vec[74], new Rectangle?(this.rectangle_7), Color.White);
        }
      }
      if (this.choice == "moon")
      {
        ...
        this.spriteBatch.Draw(this.sc.paper1, this.paperPos - origin + this.vec[7], new Rectangle?(this.rectangle_7), Color.White);
      }
